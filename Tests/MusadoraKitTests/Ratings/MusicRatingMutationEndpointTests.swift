...
@Suite
struct MusicRatingMutationEndpointTests {
  @Test
  func catalogRatingAddEndpoint() throws {
    let request = MusicCatalogRatingAddRequest(with: MusicItemID("123"), item: .song, rating: .like)
  ...
  @Test
  func catalogRatingDeleteEndpoint() throws {
    let request = MusicCatalogRatingDeleteRequest(with: MusicItemID("999"), item: .album)
  ...
  @Test
  func libraryRatingAddEndpoint() throws {
    let request = MusicLibraryRatingAddRequest(with: MusicItemID("42"), item: .song, rating: .like)
  ...
  @Test
  func libraryRatingDeleteEndpoint() throws {
    let request = MusicLibraryRatingDeleteRequest(with: MusicItemID("77"), item: .playlist)
