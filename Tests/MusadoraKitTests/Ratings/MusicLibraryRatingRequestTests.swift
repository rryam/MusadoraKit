...
@Suite struct MusicLibraryRatingRequestTests {
  ...
  @Test func addPersonalLibraryPlaylistRatingEndpointURL() throws {
    let id: MusicItemID = "1138988512"
  ...
  @Test func addPersonalLibrarySongRatingEndpointURL() throws {
    let id: MusicItemID = "1138988512"
  ...
  @Test func addPersonalLibraryMusicVideoRatingEndpointURL() throws {
    let id: MusicItemID = "1138988512"
