...
@Suite struct MusicCatalogRatingRequestTests {

  @Test func addPersonalAlbumRatingEndpointURL() throws {
  ...
  @Test func addPersonalSongRatingEndpointURL() throws {
  ...
  @Test func addPersonalPlaylistRatingEndpointURL() throws {
    let id: MusicItemID = "907242702"
  ...
  @Test func addPersonalMusicVideoRatingEndpointURL() throws {
    let id: MusicItemID = "907242702"
  ...
  @Test func addPersonalStationRatingEndpointURL() throws {
    let id: MusicItemID = "907242702"
