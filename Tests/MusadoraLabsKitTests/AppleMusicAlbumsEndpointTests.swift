...
final class AppleMusicAlbumsEndpointTests: XCTestCase {
    ...
    func testFetchACatalogAlbumByIDEndpoint() async throws {
        let id = "1456313174"
        let endpoint = try await AppleMusicEndpoint.catalogAlbum(id: id, storeFront: "in")
    ...
    func testFetchMultipleCatalogAlbumsByIDsEndpoint() async throws {
        ...
        let endpoint = try await AppleMusicEndpoint.catalogAlbums(ids: ids, storeFront: "in")
    ...
    func testFetchMultipleCatalogByUPCEndpoint() async throws {
        ...
        let endpoint = try await AppleMusicEndpoint.catalogAlbums(upcs: upcs, storeFront: "us")
    ...
    func testFetchALibraryAlbumByIDEndpoint() async throws {
        let id = "l.qrRWYhq"
        let endpoint = try await AppleMusicEndpoint.libraryAlbum(id: id)
    ...
    func testFetchMultipleLibraryAlbumsByIDsEndpoint() async throws {
        let ids = ["l.qrRWYhq"]
        let endpoint = try await AppleMusicEndpoint.libraryAlbums(ids: ids)
    ...
    func testFetchAllLibraryAlbumsEndpoint() async throws {
        let endpoint = try await AppleMusicEndpoint.libraryAlbums()
