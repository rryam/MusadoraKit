...
public extension AppleMusicEndPoint {
    static func getLibrarySong(id: String) -> Self {
        AppleMusicEndPoint(library: .user, path: "/library/songs/\(id)", addStoreFront: false)
    }
    
    static func getAllLibrarySongs(id: String) -> Self {
        AppleMusicEndPoint(library: .user, path: "/library/songs", addStoreFront: false)
    }
    
    static var userLibrary: Self {
        AppleMusicEndPoint(library: .user, path: "library", addStoreFront: false)
    }
}
