...
public extension MCatalog {
  ...
  static func playlist(for id: MusicItemID, with properties: PlaylistProperties) async throws -> Playlist {
  ...
  static func playlists(for ids: [MusicItemID], with properties: PlaylistProperties) async throws -> Playlists {
