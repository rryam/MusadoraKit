...
It goes well with my book on [*Exploring MusicKit*](exploringmusickit.com), as all the documentation and references are mentioned in the book. Otherwise, the code itself is well documented.
