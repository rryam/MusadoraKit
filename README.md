...
MusadoraKit (pronounced 'myu' za' 'do' 'ra') is the ultimate companion to MusicKit. It now so much easier to work with MusicKit and Apple Music API, with one-liner APIs for effortless implementation.
